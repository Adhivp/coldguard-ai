...
class ScanResultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color statusColor = isOk ? const Color(0xFF10B981) : const Color(0xFFEF4444);
    final Color statusBg = isOk ? const Color(0xFFECFDF5) : const Color(0xFFFEF2F2);
                    ...
                    children: [
                      Expanded(
                        child: _buildLiveMetricCard(
                          ...
                          color: current.temperature >= 2 && current.temperature <= 8 ? _accent : const Color(0xFFEF4444),
                        ),
                      ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                                ...
                                SizedBox(
                                  ...
                                  child: CircularProgressIndicator(
                                    ...
                                    valueColor: AlwaysStoppedAnimation<Color>(
                                      life.healthScore > 80 ? _accent : const Color(0xFFF59E0B),
                                    ),
                                  ),
                                ),
                                Text(
                        ...
                        _buildAnalyticsRow('Remaining Shelf Life', '${life.daysRemaining} Days', icon: Icons.timelapse_rounded, color: _accent),
                        _buildAnalyticsRow('Adjusted Life', '${life.adjustedDaysRemaining} Days', icon: Icons.history_toggle_off_rounded, color: const Color(0xFF8B5CF6)),
